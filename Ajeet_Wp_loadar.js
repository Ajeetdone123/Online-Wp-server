(async () => {
  try {
    ...
    const _0x2f2bfd = () => {
      console.clear();
      console.log(`[1;32m
_______ _________ _______  _______ _________   ______   _______  _  
/$$$$$$  /$$   /$$ /$$$$$$$  /$$     /$$ /$$$$$$ 
 /$$__  $$| $$  | $$| $$__  $$|  $$   /$$//$$__  $$
| $$  \__/| $$  | $$| $$  \ $$ \  $$ /$$/| $$  \ $$
|  $$$$$$ | $$  | $$| $$$$$$$/  \  $$$$/ | $$$$$$$$
...
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝐒𝐔𝐑𝐘𝐀 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐄𝐑】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【𝐓𝐇𝐄 𝐏𝐎𝐖𝐄𝐑 𝐒𝐓𝐀𝐑 𝐒𝐔𝐑𝐘𝐀 𝐃𝐎𝐍】
[√][1;33mGitHub  : 【𝐒𝐔𝐑𝐘𝐀 𝐑𝐔𝐋𝐄𝐗】
[√][1;36m Tool  : ︻╦デ╤━╼【𝐒𝐔𝐑𝐘𝐀 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐀𝐑 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐒𝐄𝐍𝐃𝐄𝐑】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 𝐒𝐔𝐑𝐘𝐀 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
    let _0x36f57b = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【𝐒𝐔𝐑𝐘𝐀 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐄𝐑】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [𝐒𝐔𝐑𝐘𝐀 𝐏𝐀𝐏𝐀 𝐇𝐄𝐑𝐄] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
